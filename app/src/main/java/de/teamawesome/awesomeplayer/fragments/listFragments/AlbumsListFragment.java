...
public class AlbumsListFragment extends de.teamawesome.awesomeplayer.listFragments.CursorListFragment {
    /**
    ...
    public void onListItemClick(ListView l, View v, int position, long id) {
        Bundle arguments = de.teamawesome.awesomeplayer.listFragments.ListBundles.MEDIA_FROM_ALBUM_BUNDLE.get();
